...
def load_models():
    ...
    bp_X = bp_df[["Age","BMI","Salt_Intake","BP_History","Smoking_Status"]]
    ...
    liver_X = liver_df[["age","gender","tot_bilirubin","direct_bilirubin","tot_proteins","albumin","ag_ratio"]]
